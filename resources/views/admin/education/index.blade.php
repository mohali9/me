...
<div class="panel panel-default">
	<div class="modal-body">
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">Input Data education</h5>
		...
		<table class="table">
			...
			<tbody>
				<tr>
					<td>{{$data_education1->title}}</td>
					<td>{{$data_education1->title1}}</td>
					<td>{!!$data_education1->description1!!}</td>
					<td>{{$data_education1->title2}}</td>
					<td>{{$data_education1->description2}}</td>
					<td>{{$data_education1->title3}}</td>
					<td>{{$data_education1->description3}}</td>
					<td>{{$data_education1->title4}}</td>
					<td>{{$data_education1->description4}}</td>
					<td>{{$data_education1->title5}}</td>
					<td>{{$data_education1->description5}}</td>
					<td>
						<a href="/admin/education/{{$data_education1->id}}/edit" class="btn btn-file fa fa-pencil-square-o">Edit</a>
						<a href="/admin/education/{{$data_education1->id}}/delete" type="button" class="btn-file fa fa-trash-o hapus">Delete</a>
					</td>
				</tr>
			</tbody>
			@endforeach
